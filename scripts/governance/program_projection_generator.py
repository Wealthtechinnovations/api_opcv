...
def main():
    ...
    snapshot={
        ...
        "latest_programme_evidence":director.get("projection_writeback_latest_evidence") or director.get("projection_writeback_simulation_evidence") or director.get("projection_generator_latest_evidence") or director.get("projection_drift_latest_evidence") or director.get("anti_regression_latest_evidence") or director.get("latest_evidence_ref"),
    }
