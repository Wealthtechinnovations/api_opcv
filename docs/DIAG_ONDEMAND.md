...
Derniere execution : **2026-09-26 11:09 UTC**

```
########## scripts/diag/ondemand/diag_cas_isoles.js ##########

=== CAS ISOLES — ruptures hors defaut de devise SEC ===
Mesure le 2026-09-26 11:07:46 UTC — LECTURE SEULE
...
Mesure le 2026-09-26 11:08:43 UTC — LECTURE SEULE
...
## A. Tables de classement
  ...
  performences               79459 lignes — updated_at max = aucune (?)
  performences_eurs          36332 lignes — date max = Fri Sep 25 2026 00: (1.5 j)
  performences_usds          36565 lignes — date max = Fri Sep 25 2026 00: (1.5 j)

## B. Retard des performances par pays

  pays        fonds  a jour      %  retard moy.  retard max
  ---------- ------ ------- ------ ------------ -----------
  MAROC         640      20  3.1 %      116.6 j       132 j
  TUNISIE       131       5  3.8 %      113.8 j       130 j
  UEMOA         109      36 33.0 %       36.0 j       272 j
...
=== VERDICT DE LA DERNIERE EXECUTION DE CHAQUE CRON ===
  ...
  ---------------------- -------------------- ---------------------------------- --------  ------------------------
  cron_nigeria_weekly    lundi 10:00          africafunds_nigeria_20260921.log      5.0 j  ECHEC — 8 erreur(s)
  cron_daily_update      lun-ven 20:00        africafunds_daily_20260925.log       13.9 h  ECHEC — 2 erreur(s)
  cron_daily_eur_usd     tous les j 21:30     cron_eur_usd.log                     13.1 h  ECHEC — 2 erreur(s)
  cron_tunisie_daily     lun-ven 19:00        cron_tunisie.log                     16.1 h  OK
  cron_brvm_daily        lun-ven 19:30        cron_brvm.log                        15.6 h  OK
  cron_indices_daily     lun-ven 18:30        cron_indices_daily.log               16.6 h  OK  (reserve : Echecs scraping: 24)
  cron_health_check      tous les j 22:00     africafunds_health_20260925.log      13.1 h  ECHEC — 3 probleme(s)
...
--- cron_daily_update (ECHEC — 2 erreur(s)) — /var/log/africafunds_daily_20260925.log
  | === VERIFICATION FINALE ===
  | ============================================================
  | performences_eurs: 36332 lignes, 1244 fonds
  | performences_usds: 36565 lignes, 1244 fonds
  | Termine.
  | [8/9] OK
  ...
  | === MISE A JOUR TERMINEE AVEC 2 ERREUR(S) Fri Sep 25 09:17:39 PM UTC 2026 ===
  | ========================================
...
--- cron_daily_eur_usd (ECHEC — 2 erreur(s)) — /var/log/cron_eur_usd.log
  ...
  | CRON EUR/USD TERMINE AVEC 2 ERREUR(S) — 2026-09-25 22:04:17

--- cron_health_check (ECHEC — 3 probleme(s)) — /var/log/africafunds_health_20260925.log
  |   nigeria      pas attendu aujourd'hui (pas lundi)
  | === RESUME ===
  | STATUT: 3 PROBLEME(S) DETECTE(S)
  |   [!] CEMAC: derniere VL il y a 652 jours (budget 400j)
  |   [!] Performances en retard sur les VL: 392/1234 a jour (31.8 %), retard moyen 77.7 j
  ...
  |   [OK] Forex a jour
  | === HEALTH CHECK TERMINE Fri Sep 25 10:00:03 PM UTC 2026 ===
  | ========================================
...
--- sync_production (aucun marqueur de fin) — /var/log/sync_production.log
  ...
  | ============================================
  | SNAPSHOT PRODUCTION — 2026-09-26 11:00:01
  | ============================================
  | --- Generation du snapshot base de donnees ---
  |   -> Snapshot runtime genere: /var/lib/fundafrica/runtime/PRODUCTION_STATE.json (44803 octets)
  |   -> Git non modifie: aucun add/commit/push
  | ============================================
  | SNAPSHOT TERMINE — 2026-09-26 11:00:17
  | ============================================
  | Etat production runtime: /var/lib/fundafrica/runtime/PRODUCTION_STATE.json
  | Le depot Git reste une source de code canonique, pas une sortie de cron.
...
============================================================
 ...
 Genere le 2026-09-26T11:08:48.991Z — LECTURE SEULE
============================================================
...
## A. Etat du CSV
   ...
   taille    : 9.95 Mo
   modifie   : 2026-09-21T10:00:32.286Z (il y a 121.1 h)
   lignes    : 7942
   colonnes  : 59
...
Mesure le 2026-09-26 11:08:49 UTC — LECTURE SEULE
...
Mesure le 2026-09-26 11:08:55 UTC — LECTURE SEULE
...
[7bis] Version du code REELLEMENT deployee
  HEAD : 83127cde5 — chore(governance): certify all current Markdown [skip ci]
  ...
  Process PM2 :
    api-monolith             online     redemarrages  169  depuis 344.8 h
    fundafrique-frontend     online     redemarrages   48  depuis 987.0 h
    worker-recalculation     online     redemarrages    3  depuis 344.9 h
    worker-data-import       online     redemarrages    3  depuis 344.9 h
...
Mesure le 2026-09-26T11:09:01.044Z
...
MARIADB_PROCESS pid=3041009 uptime_s=362639 rss_kb=5243432 rssanon_kb=5230420 private_dirty_kb=5232156 swap_kb=1257088
...
Mesure le 2026-09-26 11:09:01 UTC — LECTURE SEULE
...
Mesure le 2026-09-26 11:09:06 UTC — LECTURE SEULE
...
Mesure le 2026-09-26 11:09:11 UTC — LECTURE SEULE
...
Mesure: 2026-09-26T11:09:16.700Z
STEP3_RECALC_EUR_USD funds=1249 vl_rows=996087 dynamic_update_statements=2607 batch_size=500
STEP4_RECALC_VL_AJUSTE funds=1250 vl_rows=996691 dynamic_update_statements=5715 batch_size=200
COMBINED_DYNAMIC_UPDATE_STATEMENTS=8322
MYSQL_MAX_PREPARED_STMT_COUNT=16382
MYSQL_PERFORMANCE_SCHEMA=OFF
MYSQL_PREPARED_STMT_COUNT_NOW=32
MYSQL_COM_STMT_PREPARE_SINCE_RESTART=8797
MYSQL_COM_STMT_EXECUTE_SINCE_RESTART=181922
MYSQL_COM_STMT_CLOSE_SINCE_RESTART=0
MYSQL_MEMORY_USED_NOW=483261672
MYSQL_UPTIME=362662
PREPARE_MINUS_THEORETICAL_DYNAMIC=475
...
Mesure le 2026-09-26 11:09:24 UTC — LECTURE SEULE
