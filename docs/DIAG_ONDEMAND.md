...
## A. Tables de classement
  ...
  performences_eurs          32034 lignes — date max =  hu Sep 10 2026 00: (4.6 j)
  performences_usds          32267 lignes — date max =  hu Sep 10 2026 00: (4.6 j)
...
--- cron_daily_eur_usd (ECHEC — 2 erreur(s)) — /var/log/cron_eur_usd.log
  ...
  | CRON EUR/USD TERMINE AVEC 2 ERREUR(S) — 2026-09-13 22:05:06

--- cron_health_check (ECHEC — 5 probleme(s)) — /var/log/africafunds_health_20260913.log
  |   nigeria      pas attendu aujourd'hui (pas lundi)
  | === RESUME ===
  | STATUT: 5 PROBLEME(S) DETECTE(S)
  |   [!] TUNISIE: derniere VL il y a 16 jours (budget 9j)
  |   [!] NIGERIA: derniere VL il y a 30 jours (budget 14j)
  |   [!] CEMAC: derniere VL il y a 640 jours (budget 400j)
  ...
  |   [OK] Forex a jour
  | === HEALTH CHECK TERMINE Sun Sep 13 10:00:03 PM UTC 2026 ===
  | ========================================
...
--- sync_production (aucun marqueur de fin) — /var/log/sync_production.log
  ...
  | (node:1781307) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise whic
  | (node:1781307) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit
  |   -> Snapshot runtime genere: /var/lib/fundafrica/runtime/PRODUCTION_STATE.json (0 octets)
  |   -> Git non modifie: aucun add/commit/push
  | ============================================
  | SNAPSHOT TERMINE — 2026-09-14 14:00:02
  | ============================================
