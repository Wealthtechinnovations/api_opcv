...
Derniere execution : **2026-09-25 13:48 UTC**

```
########## scripts/diag/ondemand/diag_cas_isoles.js ##########

=== CAS ISOLES — ruptures hors defaut de devise SEC ===
Mesure le 2026-09-25 13:45:54 UTC — LECTURE SEULE
...
Mesure le 2026-09-25 13:46:50 UTC — LECTURE SEULE
...
## A. Tables de classement
  ...
  performences_eurs          35890 lignes — date max =  hu Sep 24 2026 00: (1.6 j)
  performences_usds          36123 lignes — date max =  hu Sep 24 2026 00: (1.6 j)
...
## C. Le classement suit-il les performances actuelles ?
  ...
  OBLIGATIONS MAROC                strict   93/300  (31.0 %) · rho  0.696 · top10 3/10 · ex aequo 1
...
=== VERDICT DE LA DERNIERE EXECUTION DE CHAQUE CRON ===
  ...
  ---------------------- -------------------- ---------------------------------- --------  ------------------------
  cron_nigeria_weekly    lundi 10:00          africafunds_nigeria_20260921.log      4.2 j  ECHEC — 8 erreur(s)
  cron_daily_update      lun-ven 20:00        africafunds_daily_20260924.log       16.5 h  ECHEC — 2 erreur(s)
  cron_daily_eur_usd     tous les j 21:30     cron_eur_usd.log                     15.7 h  ECHEC — 2 erreur(s)
  cron_tunisie_daily     lun-ven 19:00        cron_tunisie.log                     18.8 h  OK
  cron_brvm_daily        lun-ven 19:30        cron_brvm.log                        18.3 h  OK
  cron_indices_daily     lun-ven 18:30        cron_indices_daily.log               19.3 h  OK  (reserve : Echecs scraping: 23)
  cron_health_check      tous les j 22:00     africafunds_health_20260924.log      15.8 h  ECHEC — 3 probleme(s)
...
--- sync_production (aucun marqueur de fin) — /var/log/sync_production.log
  ...
  | ============================================
  | SNAPSHOT PRODUCTION — 2026-09-25 13:00:01
  | ============================================
  ...
  | ============================================
  | SNAPSHOT TERMINE — 2026-09-25 13:00:16
  | ============================================
  | Etat production runtime: /var/lib/fundafrica/runtime/PRODUCTION_STATE.json
  | Le depot Git reste une source de code canonique, pas une sortie de cron.
...
============================================================
 ...
 Genere le 2026-09-25T13:46:55.011Z — LECTURE SEULE
============================================================
...
## A. Etat du CSV
   ...
   taille    : 9.95 Mo
   modifie   : 2026-09-21T10:00:32.286Z (il y a 99.8 h)
   lignes    : 7942
   colonnes  : 59
...
Mesure le 2026-09-25 13:46:55 UTC — LECTURE SEULE
...
Mesure le 2026-09-25 13:47:01 UTC — LECTURE SEULE
...
[7bis] Version du code REELLEMENT deployee
  HEAD : 1b37d59d7 — feat(diag): controle C9 — couverture benchmark des VL recentes (30 j)
  ...
  Process PM2 :
    api-monolith             online     redemarrages  169  depuis 323.4 h
    fundafrique-frontend     online     redemarrages   48  depuis 965.6 h
    worker-recalculation     online     redemarrages    3  depuis 323.6 h
    worker-data-import       online     redemarrages    3  depuis 323.6 h
...
Mesure le 2026-09-25T13:47:06.896Z
...
MARIADB_PROCESS pid=3041009 uptime_s=285725 rss_kb=5954588 rssanon_kb=5940700 private_dirty_kb=5940904 swap_kb=501296
...
Mesure le 2026-09-25 13:47:07 UTC — LECTURE SEULE
...
Mesure le 2026-09-25 13:47:11 UTC — LECTURE SEULE
...
Mesure le 2026-09-25 13:47:17 UTC — LECTURE SEULE
...
Mesure: 2026-09-25T13:47:22.919Z
...
MYSQL_COM_STMT_PREPARE_SINCE_RESTART=8702
MYSQL_COM_STMT_EXECUTE_SINCE_RESTART=139063
MYSQL_COM_STMT_CLOSE_SINCE_RESTART=0
MYSQL_MEMORY_USED_NOW=482105968
MYSQL_UPTIME=285748
PREPARE_MINUS_THEORETICAL_DYNAMIC=383
...
Mesure le 2026-09-25 13:47:30 UTC — LECTURE SEULE
