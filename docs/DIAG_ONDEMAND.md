...
Derniere execution : **2026-09-14 12:21 UTC**
...
=== VERDICT DE LA DERNIERE EXECUTION DE CHAQUE CRON ===
  ...
  ---------------------- -------------------- ---------------------------------- --------  ------------------------
  cron_nigeria_weekly    lundi 10:00          africafunds_nigeria_20260914.log      2.3 h  ECHEC — 8 erreur(s)
  cron_daily_update      lun-ven 20:00        africafunds_daily_20260911.log        2.6 j  ECHEC — 2 erreur(s)
  cron_daily_eur_usd     tous les j 21:30     cron_eur_usd.log                     14.3 h  ECHEC — 2 erreur(s)
  cron_tunisie_daily     lun-ven 19:00        cron_tunisie.log                      2.7 j  OK
  cron_brvm_daily        lun-ven 19:30        cron_brvm.log                         2.7 j  OK
  cron_indices_daily     lun-ven 18:30        cron_indices_daily.log                2.7 j  OK  (reserve : Echecs scraping: 23)
  cron_health_check      tous les j 22:00     africafunds_health_20260913.log      14.4 h  ECHEC — 5 probleme(s)
...
--- sync_production (aucun marqueur de fin) — /var/log/sync_production.log
  ...
  | (node:1233656) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise whic
  | (node:1233656) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit
  |   -> Snapshot runtime genere: /var/lib/fundafrica/runtime/PRODUCTION_STATE.json (0 octets)
  |   -> Git non modifie: aucun add/commit/push
  | ============================================
  | SNAPSHOT TERMINE — 2026-09-14 12:00:01
  | ============================================
...
============================================================
 ...
 Genere le 2026-09-14T12:21:12.185Z — LECTURE SEULE
============================================================
...
## A. Etat du CSV
   ...
   taille    : 9.38 Mo
   modifie   : 2026-09-14T10:00:32.627Z (il y a 2.3 h)
   lignes    : 7487
   colonnes  : 59
...
[7bis] Version du code REELLEMENT deployee
  HEAD : 20cdc5f83 — chore(governance): certify all current Markdown [skip ci]
  ...
  Process PM2 :
    api-monolith             online     redemarrages  169  depuis 58.0 h
    fundafrique-frontend     online     redemarrages   48  depuis 700.2 h
    worker-recalculation     online     redemarrages    3  depuis 58.1 h
    worker-data-import       online     redemarrages    3  depuis 58.1 h
