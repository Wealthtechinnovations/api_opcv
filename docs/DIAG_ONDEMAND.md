...
Derniere execution : **2026-09-15 11:30 UTC**

```
########## scripts/diag/ondemand/diag_cas_isoles.js ##########

=== CAS ISOLES — ruptures hors defaut de devise SEC ===
Mesure le 2026-09-15 11:27:55 UTC — LECTURE SEULE
...
Mesure le 2026-09-15 11:28:52 UTC — LECTURE SEULE
...
## A. Tables de classement
  ...
  performences               76091 lignes — updated_at max = aucune (?)
  performences_eurs          32698 lignes — date max = Fri Sep 11 2026 00: (4.5 j)
  performences_usds          32931 lignes — date max = Fri Sep 11 2026 00: (4.5 j)

## B. Retard des performances par pays

  pays        fonds  a jour      %  retard moy.  retard max
  ---------- ------ ------- ------ ------------ -----------
  MAROC         640      18  2.8 %      108.3 j       119 j
  TUNISIE       131       8  6.1 %       89.7 j       102 j
  UEMOA         109      38 34.9 %       26.8 j        98 j
...
=== VERDICT DE LA DERNIERE EXECUTION DE CHAQUE CRON ===
  ...
  ---------------------- -------------------- ---------------------------------- --------  ------------------------
  cron_nigeria_weekly    lundi 10:00          africafunds_nigeria_20260914.log     25.4 h  ECHEC — 8 erreur(s)
  cron_daily_update      lun-ven 20:00        africafunds_daily_20260914.log       14.3 h  ECHEC — 2 erreur(s)
  ...
  cron_health_check      tous les j 22:00     africafunds_health_20260914.log      13.5 h  ECHEC — 5 probleme(s)
...
--- cron_daily_update (ECHEC — 2 erreur(s)) — /var/log/africafunds_daily_20260914.log
  | === VERIFICATION FINALE ===
  | ============================================================
...
--- cron_health_check (ECHEC — 5 probleme(s)) — /var/log/africafunds_health_20260914.log
  |   nigeria      /var/log/africafunds_nigeria_20260914.log — 17 Ko, modifie il y a 11h
  | === RESUME ===
...
--- sync_production (aucun marqueur de fin) — /var/log/sync_production.log
  ...
  | ============================================
  | SNAPSHOT PRODUCTION — 2026-09-15 11:00:01
  | ============================================
  | --- Generation du snapshot base de donnees ---
  |   -> Snapshot runtime genere: /var/lib/fundafrica/runtime/PRODUCTION_STATE.json (44884 octets)
  |   -> Git non modifie: aucun add/commit/push
  | ============================================
  | SNAPSHOT TERMINE — 2026-09-15 11:00:16
  | ============================================
  | Etat production runtime: /var/lib/fundafrica/runtime/PRODUCTION_STATE.json
  | Le depot Git reste une source de code canonique, pas une sortie de cron.
...
============================================================
 ...
 Genere le 2026-09-15T11:28:57.955Z — LECTURE SEULE
============================================================
...
## A. Etat du CSV
   ...
   taille    : 9.38 Mo
   modifie   : 2026-09-14T10:00:32.627Z (il y a 25.5 h)
   lignes    : 7487
   colonnes  : 59
...
Mesure le 2026-09-15 11:28:58 UTC — LECTURE SEULE
...
Mesure le 2026-09-15 11:29:04 UTC — LECTURE SEULE
...
[7bis] Version du code REELLEMENT deployee
  HEAD : cc1bb77a2 — chore(governance): certify all current Markdown [skip ci]
  ...
  Process PM2 :
    api-monolith             online     redemarrages  169  depuis 81.1 h
    fundafrique-frontend     online     redemarrages   48  depuis 723.3 h
    worker-recalculation     online     redemarrages    3  depuis 81.3 h
    worker-data-import       online     redemarrages    3  depuis 81.3 h
...
Mesure le 2026-09-15 11:29:11 UTC — LECTURE SEULE
...
Mesure le 2026-09-15 11:29:16 UTC — LECTURE SEULE
...
Mesure le 2026-09-15 11:29:21 UTC — LECTURE SEULE
...
Mesure le 2026-09-15 11:29:26 UTC — LECTURE SEULE
