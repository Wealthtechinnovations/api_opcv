...
Derniere verification : **2026-09-15 11:30 UTC**
...
[ALERTE] C4.CEMAC     Fraicheur VL CEMAC (budget 400 j)
             derniere VL Thu Dec 12, soit 642 j
[OK   ] C4.MAROC     Fraicheur VL MAROC (budget 6 j)
             derniere VL Fri Sep 11, soit 4 j
[ECHEC] C4.NIGERIA   Fraicheur VL NIGERIA (budget 14 j)
             derniere VL Fri Aug 28, soit 18 j
...
[OK   ] C5           Snapshot production runtime frais (< 6 h)
             runtime: genere le 2026-09-15T11:00, soit 0.5 h
...
[ECHEC] C8           Les performances suivent les VL
             MAROC : 8/644 a jour (1.2 %), retard moyen 108.3 j | UEMOA : 36/111 a jour (32.4 %), retard moyen 26.8 j — VL fraiches mais performances perimees : le site affiche des chiffres plausibles et faux
[ALERTE] C6.CEMAC     Couverture indRef CEMAC
             0.0 % (2134 VL sans benchmark sur 2134)
[OK   ] C6.MAROC     Couverture indRef MAROC
             98.5 % (8644 VL sans benchmark sur 559510)
...
[OK   ] C6.UEMOA     Couverture indRef UEMOA
             100.0 % (0 VL sans benchmark sur 47927)
