...
Derniere verification : **2026-09-22 20:46 UTC**
...
[ECHEC] C2           Aucune performance orpheline en tete de serie
             performences:15, performences_eurs:23, performences_usds:23 fonds dont la perf la plus recente porte une date sans VL — c'est elle que l'API sert. Instruire fonds par fonds AVANT toute suppression.
...
[OK   ] C5           Snapshot production runtime frais (< 6 h)
             runtime: genere le 2026-09-22T20:00, soit 0.7 h
...
[ECHEC] C8           Les performances suivent les VL
             MAROC : 8/644 a jour (1.2 %), retard moyen 115.6 j | TUNISIE : 5/131 a jour (3.8 %), retard moyen 111.9 j | UEMOA : 35/111 a jour (31.5 %), retard moyen 33.5 j — VL fraiches mais performances perimees : le site affiche des chiffres plausibles et faux
[ALERTE] C6.CEMAC     Couverture indRef CEMAC
             0.0 % (2134 VL sans benchmark sur 2134)
[OK   ] C6.MAROC     Couverture indRef MAROC
             98.1 % (10824 VL sans benchmark sur 561690)
