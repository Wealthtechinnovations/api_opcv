...
const {
  ...
  extendedData.sort((a, b) =>  new Date(b.date)  - new Date(a.date));
         ...
         expObject.date = grouperTauxParSemaine(expObject.semaine);
          ...
          if (req.params.year === "1") {
            ...
            if (rendementsTableau['1_an'].length > 0) {
              ...
              const sortino = calculateSortinoRatio([...rendementsTableau["1_an"]], tauxsr, 0.01);
              const sortinojour = calculateSortinoRatio([...rendementsTableaujour["1_an"]], tauxsr, 0.01);
              const sortinomois = calculateSortinoRatio([...rendementsTableaumois["1_an"]], tauxsr, 0.01);
            ...
            const sortino = calculateSortinoRatio([...rendementsTableau["3_ans"]], tauxsr, 0.01);
            const sortinojour = calculateSortinoRatio([...rendementsTableaujour["3_ans"]], tauxsr, 0.01);
            const sortinomois = calculateSortinoRatio([...rendementsTableaumois["3_ans"]], tauxsr, 0.01);
            ...
            const sortino = calculateSortinoRatio([...rendementsTableau["5_ans"]], tauxsr, 0.01);
            const sortinojour = calculateSortinoRatio([...rendementsTableaujour["5_ans"]], tauxsr, 0.01);
            const sortinomois = calculateSortinoRatio([...rendementsTableaumois["5_ans"]], tauxsr, 0.01);
            ...
            const sortino = calculateSortinoRatio([...rendementsTableau["8_ans"]], tauxsr, 0.01);
            ...
            const ratioSharpe = calculateSharpeRatio(rendementsTableau["8_ans"], tauxsr)
            ...
            const sortino = calculateSortinoRatio([...rendementsTableau["10_ans"]], tauxsr, 0.01);
            ...
            const ratioSharpe = calculateSharpeRatio(rendementsTableau["10_ans"], tauxsr)
            ...
            const sortino = calculateSortinoRatio([...rendementsTableau["12_ans"]], tauxsr, 0.01);
            ...
            const ratioSharpe = calculateSharpeRatio(rendementsTableau["12_ans"], tauxsr)
            ...
            const sortino = calculateSortinoRatio([...rendementsTableau["origine"]], tauxsr, 0.01);
            ...
            const ratioSharpe = calculateSharpeRatio(rendementsTableau["origine"], tauxsr)
      ...
      console.error('Erreur route /api/ratiosnew:', error);
  ...
  function handleCalculations(req, res, donneesarray, donneesarrayindref, dates, values, valuesindifref, lastPreviousDate, years, tableauDonneestsr, tauxsr) {
    ...
    const result = {
      ...
      sortino: calculateSortinoRatio(rendementsTableau[periode], tauxsr, 0.01),
      sortinojour: calculateSortinoRatio(rendementsTableaujour[periode], tauxsr, 0.01),
      sortinomois: calculateSortinoRatio(rendementsTableaumois[periode], tauxsr, 0.01),
  ...
  router.get('/api/ratiosnewithdate1/:year/:id/:date', async (req, res) => {
    try {
         ...
         expObject.date = grouperTauxParSemaine(expObject.semaine);
          ...
          if (req.params.year === "1") {
            ...
            /*
                    ...
                    //const ratioSharpe = calculateSharpeRatio(rendementsTableau["3_ans"], tauxsr)
                  //  const ratioSharpe = calculateSharpeRatio(rendementsTableau["3_ans"], 0.000751923)
                    const ratioSharpe = (CAGR- tauxsr)/volatilites["3_ans"];
      ...
      console.error('Erreur route /api/ratiosnewithdate1:', error);
      res.status(500).json({ message: 'Erreur serveur' });
    }
  })
  ///////////////////////////////////////////////////
  ...
  router.get('/api/ratiosnewdev/:year/:id/:devise', async (req, res) => {
    try {
      ...
      console.error('Erreur route /api/ratiosnewdev:', error);
      res.status(500).json({ message: 'Erreur serveur' });
    }
  })
  ...
  router.get('/api/ratiosnewdevwithdate/:year/:id/:devise/:date', async (req, res) => {
    try {
      ...
      console.error('Erreur route /api/ratiosnewdevwithdate:', error);
      res.status(500).json({ message: 'Erreur serveur' });
    }
  })
